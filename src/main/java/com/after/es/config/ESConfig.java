...
//        System.out.println("size="+hostlist.size());
        List<HttpHost> httpHostList = getList(hostlist.size());
    ...
    public List<HttpHost> getList(int size) {
        List<HttpHost> httpHostList = new ArrayList<>(size);
        //封装es服务端地址
